...
int main( int argc, char* args[] )
{
    ...
    */
    ...
    //Controllable Box
    Object *testObj = new Object( 0.0, 0.0, 18.0, 0.6, 0.3 );
    /*
    ...
    */
    ...
    //No need for lives in sandbox mode ;)
    //Lives
    ...
    while( quit == false )
    {
                ...
                switch( event.key.keysym.sym )
                {
                    ...
                    case SDLK_q:
                        if( keypressed == false ){
                            ...
                            testObj->AddForce( 200.0, 315, 100 );
                            keypressed = true;
                        }
                        break;
                    ...
                    case SDLK_a:
                        if( keypressed == false ){
                            ...
                            testObj->AddForce( 110.0, 270, 100 );
                            keypressed = true;
                        }
                        break;
                    case SDLK_d:
                    ...
                    case SDLK_z:
                        if( keypressed == false ){
                            ...
                            testObj->AddForce( 110.0, 225, 100 );
                            keypressed = true;
                        }
                        break;
                    case SDLK_x:
                        if( keypressed == false ){
                            ...
                            testObj->AddForce( 110.0, 180, 100 );
                            keypressed = true;
                        }
                        break;
                    case SDLK_c:
                        if( keypressed == false ){
                            ...
                            testObj->AddForce( 110.0, 135, 100 );
                            keypressed = true;
                        }
                        break;
                    /*
        ...
        */
        ...
        if( newTime < 5000 ){
            glColor3f(0.0, 0.5, 1.0);
            glRasterPos2f(-0.99, -0.94);
            //printString("SANDBOX MODE HAVE FUN! 0123456789 = ! : . /");
            printString("SANDBOX MODE HAVE FUN!");
        }
